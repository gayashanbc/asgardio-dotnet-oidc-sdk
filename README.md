...
1. Download the [PickupManagerOIDC-v0.1.5.msi](https://github.com/asgardeo/asgardeo-dotnet-oidc-sdk/releases/download/v0.1.0/PickupManagerOIDC-v0.1.0.msi).
...
### Running the sample
Once the installation is complete the `Pickup Manager - OIDC v0.1.5` application wiil be launched automatically.<br/>
You can always re-launch the application by double clicking on the `Pickup Manager - OIDC v0.1.5` application available on your Desktop.<br/>
